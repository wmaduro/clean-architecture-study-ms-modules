java -jar ~/hd2/Estudo/CONCEPTS-PRJ/architecture-study/clean-architecture-study-ms-ws/clean-architecture-study-ms-modules/cas-ms-file-parser/target/cas-ms-file-parser-0.0.1-SNAPSHOT.jar &
